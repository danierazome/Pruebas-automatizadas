...
//   Fourth Functionality -> Change general Settings
  ...
  describe("Import members with CSV file", () => {
    ...
    it("Should modify general setings of the site.", () => {
        ...
        generalSettingsPage.elements.siteNameInput().click({force: true}).clear({force: true}).type("New Title Test",{force: true});
        generalSettingsPage.elements.siteNameDescription().click({force: true}).clear({force: true}).type("New Description Test",{force: true});
        generalSettingsPage.elements.saveButton().click();
        generalSettingsPage.elements.saveButton().contains("span","Saved").should("be.visible");
    });
    ...
    it("Should modify setings of the timezone y language.", () => {
        ...
        generalSettingsPage.elements.languageInput().clear({force:true}).type("es",{force:true});
        generalSettingsPage.elements.saveButton().contains("span","Saved").should("be.visible");
